...
// ============================================================================
// Rational register type
// ============================================================================

void Rational::_register(Types& t) {
    t.add(TypeInfo(TypeKind::Rational, "trust::Rational"));
    t.add(TypeInfo(TypeKind::RationalAny, "trust::Rational"));
}
