...
// (AccessShared<V, Mutex>, used only when multi-threaded synchronization is required).
...
// Fixture intentionally empty; tests exercise Locker/Shared/Weak/AccessShared types directly.
