...
#define TRUST_PRAGMA_MACROS(X)                                                                                                                                 \
    ...
    X(TryClose, "@__PRAGMA_TRY_CLOSE__",                                                                                                                     \
      ("Make the final closing brace of the current try/try_error/try_return block become the try-closer (\"*}\"/\"-}\"/\"+}\"): "                        \
       "@__PRAGMA_TRY_CLOSE__(\"*}\"). Used by the try-family DSL macros to provide classic try { ... } syntax."))                                          \
