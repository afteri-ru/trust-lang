...
Хотя встречаются языки программирования, которые пытаются решать данные проблемы за счет концепции "владения" ([Rust](https://www.rust-lang.org/), [Аргентум](https://aglang.org/) или [TrustLang](https://trust-lang.net/)). О возможном решении этих, и других имеющихся проблем со ссылками далее и пойдет речь.
