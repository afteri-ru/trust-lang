...
title: Строительные блоки языков программирования
date: 2024-05-03
tags: [programming-languages, syntax, language-design, parser]
---

В результате обратной связи по статье с [размышлениями о структурном программировании](/ru/blog/theory/structured-programming/), было много отзывов и споров в комментариях, за которые я хочу сказать всем большое спасибо. 
