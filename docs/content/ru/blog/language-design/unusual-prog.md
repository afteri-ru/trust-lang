...
Эта проблема описана в статье ["Простое сложное программирование"](/ru/blog/programming/complex-prog/) и [Какая "идеальная" цель развития у языков программирования?](/ru/blog/language-design/lang-final/)
