...
Последовательность команд [(блок кода)](/ru/docs/4_operators/block/) можно прервать в любом месте с помощью специальных операторов.
...
Именованные [блоки кода](/ru/docs/4_operators/block/) могут выступать в качестве локальных меток для передачи потока выполнения.
...
в любом [блоке кода](/ru/docs/4_operators/block/) и возвращают результат, но их еще и можно *"ловить"*. 
...
типе возвращаемого значения. Если именованные блоки кода [возвращают значение](/ru/docs/4_operators/throw/#return), 
...
Блоки кода с перехватом прерываний, совместно с оператором [оценки выражения](/ru/docs/4_operators/match/), 
