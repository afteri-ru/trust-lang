...
В языке TrustLang реализована модель обобщеного программирования, которая включает в себя лучшие стороны каждого из [варинатов реалиазции обощенного программирования](/ru/blog/generics/#compare) из мейнстрим языков. 
...
### Примеры
Классическая иллюстрация проблемы - [функция выбора максимального значения](/ru/blog/generics/). 
