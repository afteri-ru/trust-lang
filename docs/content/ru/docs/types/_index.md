...
Это напоминает реализуцию ООП в языке Java, где каждый класс имеет в своем составе наследников *Object*.

За счет закрытой иерархии типов реализуется и парадигма [обобщённого программирования (generics)](/ru/docs/syntax/generics/).
...
Типы данных разделяются на простые и сложные (составные). Простые типы данных не могут быть расширены.

Создание типов происходит согласно [правилам синтаксиса](/ru/docs/operators/create/).
