...
{{< unreleased why="описанная здесь модель времени выполнения (классы Runtime/Module/Context, Obj, Variable, VariablePair, LatterType, именованные прерывания как исключения) относится к устаревшей интерпретируемой архитектуре и не соответствует текущей реализации-транспилятору в C++" />}}
