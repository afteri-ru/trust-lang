...
[Условный оператор](/ru/docs/operators/if/)
<table>
<tr>
<td>
...
[Операторы циклов](/ru/docs/operators/while/)
<table>
<tr>
<td>
...
[Операторы оценки выражения](/ru/docs/operators/match/)
<table>
<tr>
<td>
...
[Оператор менеджера контекста](/ru/docs/operators/with/)
<table>
<tr>
<td>
