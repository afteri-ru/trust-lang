...
*TrustLang* имеет закрытую систему типов. т.е. любой новый тип данных, которые создает пользователь,
...
Фрагмент иерархии типов данных ([строки](/en/docs/types/strings/) и [числа](/en/docs/types/numbers/),
